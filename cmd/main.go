...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f62f22f2.k8s.k.io",
	...
	if err = (&controller.MySQLDatabaseReconciler{
	...
	if err = (&databasesv1.MySQLDatabase{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "MySQLDatabase")
		os.Exit(1)
	}
